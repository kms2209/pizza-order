...
<div id="templatemo_container">
  ...
  $resulta = mysqli_query($db,"SELECT * FROM marias_members WHERE id = '$id'");
	  ...
	  <div class="text">List Of Product </div>
	                  ...
	                  <div class="view1"><?php
								...
								while($row2 = mysqli_fetch_array($result2))
								  ...
								  $result3 = mysqli_query($db,"SELECT * FROM marias_products where product_id='$ble'");
	...
	<input name="transactioncode" type="hidden" value="<?php echo $_SESSION['SESS_FIRST_NAME']; ?>" />
	  ...
	  <table width="335" border="1" cellpadding="0" cellspacing="0" style="color:#000000; font-family:Arial, Helvetica, sans-serif; font-size:10px;">
        ...
        <td width="90"><div align="center"><strong>Product Name </strong></div></td>
          <td width="84"><div align="center"><strong></strong></div></td>
          <td width="27"><div align="center"><strong>Qty</strong></div></td>
          <td width="45"><div align="center"><strong></strong></div></td>
...
$resulta = mysqli_query($db,"SELECT * FROM orderdetails WHERE transactioncode = '$memid'");
...
$memid = $_SESSION['SESS_FIRST_NAME'];
		  $result = mysqli_query($db,"SELECT sum(total) FROM orderdetails WHERE transactioncode = '$memid'");
